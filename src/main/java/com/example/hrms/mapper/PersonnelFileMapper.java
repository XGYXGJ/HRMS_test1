...
public interface PersonnelFileMapper extends BaseMapper<PersonnelFile> {
    // 自定义查询：联表查询档案和机构名称
    List<PersonnelFileDTO> selectFilesWithOrgName(@Param("l3OrgId") Integer l3OrgId, @Param("q") String q);
    
    List<PersonnelFileDTO> selectDeletedFilesWithOrgName();

    List<PersonnelFileDTO> selectAuditHistory(@Param("q") String q);
